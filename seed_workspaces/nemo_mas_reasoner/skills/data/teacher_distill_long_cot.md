...
When to use: a `data_gap` (or a `recipe_proposal` from Theorist)
...
## Hard rules (re-stated from data_engineer.md)
...
body: |
  ...
  Caveats / next steps:
    - <e.g. "yield was 22%, below the 30% target — Analyst should
...
an Analyst to audit your batch.
