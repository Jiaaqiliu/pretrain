...
def test_builtin_generators_registered_on_data_import():
    import agent_evolve.model.data  # noqa: F401
...
def test_generate_stage_is_registered():
    ...
    from agent_evolve.model.stage_registry import STAGE_TYPES

    import agent_evolve.model.runners  # noqa: F401 — triggers
...
def test_generate_stage_dispatches_to_registered_generator(tmp_path):
    ...
    from agent_evolve.model.runners.stages.generate import _generate_stage_adapter
    from agent_evolve.model.stage_registry import StageContext
