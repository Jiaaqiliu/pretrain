...
\paragraph{Downstream evaluation.} The 3-way schedule comparison (\S\ref{sec:schedule}) uses training loss as the metric. Full downstream benchmark evaluation (MMLU, HellaSwag, etc.) on the resulting checkpoints would strengthen the prescriptive claim but is not included in the current version.
